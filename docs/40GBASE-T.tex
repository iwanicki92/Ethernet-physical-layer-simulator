...
40GBASE-T PCS (Physical Coding Sublayer) jest warstwą odpowiedzialną za kodowanie i dekodowanie oraz skramblowanie i deskramblowanie.
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{dsq128.png}
