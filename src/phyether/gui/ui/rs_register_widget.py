...
class Ui_rsRegisterForm(object):
    def setupUi(self, rsRegisterForm):
        ...
        self.fillSpinBox = QtWidgets.QSpinBox(rsRegisterForm)
        self.fillSpinBox.setMaximum(1)
        self.fillSpinBox.setObjectName("fillSpinBox")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.fillSpinBox)
